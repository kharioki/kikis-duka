...
export default function HomePage() {
   ...
   * This function modifies the top-level browser URL so that you can navigate within the embedded app and keep the browser in sync on reload.
   */
  ...
  const emptyStateMarkup = !isLoading && !QRCodes?.length ? (
    <Card sectioned>
      <EmptyState
        ...
        /** 
         * This button will tke the user to create a QR code page
        */
        action={{
